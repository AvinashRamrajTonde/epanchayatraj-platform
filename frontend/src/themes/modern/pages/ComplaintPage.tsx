...
export default function ComplaintPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <div className="bg-gradient-to-r from-red-700 to-orange-600 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">तक्रार नोंदवा</h1>
          <p className="text-red-100 text-lg">ग्रामपंचायत क्षेत्रातील समस्यांसाठी तुमची तक्रार येथे नोंदवा</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <select name="category" value={form.category} onChange={handleChange}
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-red-400 outline-none bg-white">
            ...
            <div>
              ...
              <textarea name="description" value={form.description} onChange={handleChange} rows={5}
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-red-400 outline-none resize-none"
                placeholder="समस्येचे सविस्तर वर्णन लिहा — ठिकाण, स्वरूप, किती दिवसांपासून आहे इ." />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">फोटो पुरावा (पर्यायी)</label>
              {imagePreview ? (
